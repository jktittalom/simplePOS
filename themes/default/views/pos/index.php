                ...
                <table style="width:100%;" class="layout-table">
                    <tr>
                            ...
                            <div id="pos">
                                ...
                                <div class="well well-sm" id="leftdiv">
                                    ...
                                    <div id="payment-con">
                                        ...
                                        <input type="hidden" name="printer" id="printer" value=""/>
                                    </div>
                        ...
                        <ul class="control-sidebar-menu" style="display:flex;" >
                                ...
                                <?php } ?>
                                <?php if($store->filter_option == 2 || $store->filter_option == 0) { ?>
                                <div id="search-barcode">
                                    <div class="form-group" style="margin-bottom:5px;">
                                        <input type="text" name="code" id="add_item" class="form-control" placeholder="<?=lang('search__scan')?>" />
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        <?php if ($this->session->userdata('rmspos')) { ?>
            ...
            <?php if ($sid) { ?>
               ...
               // console.log('11:Jiten: save in browser localstroage-- spos_tax');
                ...
                <?php } elseif ($eid) { ?>
                    ...
                    //console.log('22 Jiten: save in browser localstroage-- spos_tax');
                    ...
                    <?php } else { ?>
                        ...
                        if (! get('spos_tax')) {
                            //console.log('33 Jiten: save in browser localstroage-- spos_tax');
                            //store('spos_tax', '<?=$Settings->default_tax_rate;?>');  //comment By Jiten, 18 Aug 2021
                            //$('#tax_val').val('<?=$Settings->default_tax_rate;?>');  //comment By Jiten, 18 Aug 2021
                            store('spos_tax', '<?=$store->vat;?>');
                            $('#tax_val').val('<?=$store->vat;?>');
                        }
                        <?php } ?>
