...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#prTables').DataTable({
            ...
            //{ "data": "tax" }, // By Jiten hide Tax, 18 Aug 2021 
                    ...
                    <table id="prTables" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                        <thead>
                            <tr class="active">
                                ...
                                <!-- <th class="col-xs-1"><?= lang("tax"); ?></th> // By Jiten hide Tax, 18 Aug 2021 -->
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <!-- <th class="col-xs-1"><input type="text" class="text_filter" placeholder="[<?= lang('tax'); ?>]"></th>  // By Jiten hide Tax, 18 Aug 2021 -->
                                <th class="col-xs-1">
