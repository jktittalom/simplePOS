                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <?= form_input('vat_id', set_value('vat_id', $store->vat_id), 'class="form-control input-sm" id="vat_id"');?>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="vat"><?= $this->lang->line("vat"); ?></label>
                            <?= form_input('vat', set_value('vat', $store->vat), 'class="form-control input-sm" id="vat"');?>
                        </div>
                        <div class="form-group">
